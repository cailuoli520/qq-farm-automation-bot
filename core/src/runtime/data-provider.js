...
function createDataProvider(options) {
    ...
    return {
        ...
        doFarmLandOp: (accountRef, landId, opType) => callWorkerApi(resolveAccountRefId(accountRef), 'doFarmLandOp', landId, opType),
        ...
        saveSettings: async (accountRef, payload) => {
            ...
            const snapshot = {
                ...
                harvestDelaySeconds: body.harvestDelaySeconds,
                plantOrderRandom: body.plantOrderRandom,
                plantDelaySeconds: body.plantDelaySeconds,
                fertilizerDelaySeconds: body.fertilizerDelaySeconds,
                autoReconnectEnabled: body.autoReconnectEnabled,
                reconnectMinSeconds: body.reconnectMinSeconds,
                reconnectMaxSeconds: body.reconnectMaxSeconds,
            ...
            return {
                ...
                harvestDelaySeconds: store.getHarvestDelaySeconds(accountId),
