# QQ 农场多账号挂机 + Web 面板
## 作者QQ：1503938233--付费版请咨询出售重构版V2.3.3源码不包更有docker部署，随意二改
...
## 开源版停止维护，但是请不要贩卖开源版本，免费项目，禁止倒卖！所有功能都是正常使用的，只需要更新一下core/src/config/config.js里面的版本号然后重启后端即可，开源版本请自行解决各种部署问题、使用问题等，感谢各位支持！
---
## 技术栈
